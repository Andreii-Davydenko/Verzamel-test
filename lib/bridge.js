...
contextBridge.exposeInMainWorld('ipc', {
  ...
  updateWebsite: (website) => ipcRenderer.invoke('updateWebsite', website),
  deleteWebsite: (id) => ipcRenderer.invoke('deleteWebsite', id),
  getAllWebsites: () => ipcRenderer.invoke('getAllWebsites'),
  getWebsitesByIds: (ids) => ipcRenderer.invoke('getWebsitesByIds', ids),
  initBrowser: () => ipcRenderer.invoke('initBrowser'),
  fetchInvoices: (dateRange, websiteIdsToFetchFor) => ipcRenderer.invoke(
    'fetchInvoices',
    dateRange,
  ...
  insertEmailedInvoice: (combination) => ipcRenderer.invoke('insertEmailedInvoice', combination),
  getAllEmailedInvoices: () => ipcRenderer.invoke('getAllEmailedInvoices'),
  deleteAllEmailedInvoices: () => ipcRenderer.invoke('deleteAllEmailedInvoices'),
  insertDownloadedInvoice: (combination) => ipcRenderer.invoke('insertDownloadedInvoice', combination),
  getAllDownloadedInvoices: () => ipcRenderer.invoke('getAllDownloadedInvoices'),
  deleteAllDownloadedInvoices: () => ipcRenderer.invoke('deleteAllDownloadedInvoices'),
